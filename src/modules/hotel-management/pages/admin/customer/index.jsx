...
import CustomerTableToolbar from "src/modules/hotel-management/sections/customer/table-toolbar";
import CustomerTableRow from "src/modules/hotel-management/sections/customer/table-row";
import CustomerTableLoading from "src/modules/hotel-management/sections/customer/table-loading";
...
export default function CustomerPage() {
  ...
  const { customers, total, isLoading, isDeleteSuccess } = useSelector(
  ...
  const handleDeleteAgree = () => {
    ...
    dispatch(deleteCustomer({ ids: deleteIds.toString() }));
  };
  ...
  return (
    <>
      <Helmet>
        <title> Customer | {import.meta.env.VITE_APP_NAME}</title>
      </Helmet>
            ...
            <TableContainer sx={{ overflow: "unset" }}>
              ...
              >
                ...
                <TableBody>
                  ...
                  {isLoading && <CustomerTableLoading rowCount={rowsPerPage} />}
