  ...
  return (
    <>
      ...
      >
        ...
        <TableCell>{`${row.room_number} - ${row.room_category.name}`}</TableCell>
        <TableCell>{row.branch.name}</TableCell>

        <TableCell align="center">$ {row.price}</TableCell>
        <TableCell align="center">{row.max_adult}</TableCell>
        <TableCell align="center">{row.max_children}</TableCell>
